...
- устанавливать `kubelet`;
- устанавливать `kubectl`;
- устанавливать CNI plugin;
- устанавливать Helm;
- настраивать GitOps;
- автоматизировать подготовку через Ansible.

Сначала нужно понять и вручную проверить базовое состояние Linux node.

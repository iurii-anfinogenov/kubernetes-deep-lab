...
- проверка VM-based окружения
- базовая подготовка Linux nodes
- установка и диагностика containerd
- работа с CRI через crictl
- подготовка kubeadm prerequisites
- kubeadm cluster bootstrap
- установка первого CNI
- первичная инспекция control plane, static pods, kubelet, kubeconfig и системных компонентов
- [Lab 00 - environment](./labs/lab-00-environment/README.md)
- [Lab 01 - Container runtime baseline](./labs/lab-01-node-baseline/README.md)
- [Lab 02 - CRI diagnostics with crictl](./labs/lab-02-containerd-runtime/README.md)
- [Lab 03 - kubeadm prerequisites](./labs/lab-03-kubeadm-prerequisites/README.md)
- [Lab 04 - kubeadm cluster bootstrap](./labs/lab-04-kubeadm-cluster-bootstrap/README.md)
- [Lab 05 - CNI bootstrap](./labs/lab-05-cni-bootstrap/README.md)
- [Lab 06 - kubeadm cluster inspection](./labs/lab-06-kubeadm-cluster-inspection/README.md)

Ближайшая цель:

- закрыть хвосты по lab reports участников
- проверить Pull Requests по текущим лабораторным
- выровнять понимание kubeadm bootstrap, CNI, kubelet, static pods и базовой диагностики кластера
- после этого перейти к более глубокому разбору control plane internals
